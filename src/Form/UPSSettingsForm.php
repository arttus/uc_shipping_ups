...
namespace Drupal\uc_shipping_ups\Form;
...
class UPSSettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'uc_shipping_ups_admin_settings';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $ups_config = $this->config('uc_shipping_ups.settings');
    ...
    $form['ups-settings'] = array(
      ...
      '#attached' => array(
        'library' => array(
          'uc_shipping_ups/uc_shipping_ups.scripts',
        ),
      ),
    );
    ...
    */
    ...
    $form['services']['uc_shipping_ups_services'] = array(
      '#type' => 'checkboxes',
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    $old_password = $this->config('uc_shipping_ups.settings')->get('password');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $ups_config
      ...
      ->set('services', $values['uc_shipping_ups_services'])
